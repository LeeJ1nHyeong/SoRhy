...
🖋️*Keep* : 전체적인 UI 관련 애니메이션을 추가했으며, 담당하고 있는 게임에도 필요한 UI들을 추가했습니다.

🖍️*Problem* : 수정해야 할 사항이 많아 목표했던 금요일 배포가 어려워졌습니다. 멀티플레이 관련 사항도 여전히 해결해야 할 일들이 많습니다. 이번 주 배포 진행 시 멀티플레이 관련해서 생각해봐야 할 내용들이 많습니다.

💡*Try* : 늦어도 이번 주 주말에 배포를 할 수 있도록 개발 진행하기

# 231108 회고

🖋️*Keep* : 게임 내에서 필요한 모든 API를 적용 완료하여 이상 없음을 확인했으며, 전체 게임 UI 및 HOUSE 게임에 필요한 3D 애니메이션도 추가로 구현했습니다.

🖍️*Problem* : 멀티 플레이 관련해서 해결해야 할 부분이 많아 이번 주 배포 시 멀티 플레이 부분과 관련해서 고민을 해야 할 것 같습니다.

💡*Try* : 전체 UI 및 애니매이션 구현, 멀티플레이 관련 여러 문제 해결하기

# 231107 회고

🖋️*Keep* : 게임 수정 사항을 반영하여 추가 병합을 완료했고 지속적으로 필요한 부분을 수정 및 추가로 구현 중입니다.

🖍️*Problem* : 해결을 해도 계속 늘어나는 추가 수정사항… 특히 멀티플레이 관련해서 작업해야 할 사항이 많아 걱정입니다.

💡*Try* : 빠르면 금요일, 늦어도 이번 주말 배포를 목표로 개발 계속 진행하기
